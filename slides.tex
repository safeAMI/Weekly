...
Last Changed by: \textsc{Siyi Yu}\ \gitVtagn{week_three}-\gitAbbrevHash\ (\today)
},
cf={Midterm Presentation},
}
...
%%==========================================================================================
%%
\begin{slide}{Completed Tasks}
\begin{center}
\twotonebox{\rotatebox{30}{Completed Tasks}}{\parbox{.86\textwidth}
{Completed Tasks for Three Weeks
\begin{itemize}
\item \textcolor{red}{LaTeX}
\item  \textcolor{red}{Git}
\item  \textcolor{red}{PDM}
\item  \textcolor{red}{Part of Kaggle about New York City Taxi Trip Duration}
\end{itemize}
}}
...
\begin{slide}{Kaggle}
  \begin{center}
    \begin{figure}
      \item\animategraphics[autoplay, loop, height=0.4\textheight]{6}{figures//gif//question2//q_}{1}{1}
        \item \href{https://www.kaggle.com/c/nyc-taxi-trip-duration}
        {\textsc{\textcolor{red}{New York City Taxi Trip Duration}}}
    \end{figure}
    \end{center}
\end{slide}
% %%
...
%%==========================================================================================
%%
% \begin{slide}{Midterm Representation}
% \twotonebox {\rotatebox{90}{Defn}}{\parbox{.88\textwidth}
% {
% {\textcolor{orange}{Midterm Presentation} aims to
...
% we proposed the concept of Midterm Presentation.
% \end{note}
% %%==========================================================================================
...
% \twotonebox {\rotatebox{90}{Defn}}{\parbox{.88\textwidth}
% {
% {\textcolor{orange}{Midterm Presentation} aims to identify
...
% \begin{note}
% Next,
% let me talk about the concept of Midterm Presentation.
...
% The Midterm Presentation is to identify the top-k group outlying subspaces,
...
%%==========================================================================================
  ...
  \begin{table}[h]
	  \begin{tabular}{|l||r|}
		  ...
		  04 -05 & Python Basics \\
	  	\hline
		  04-05 & Data Visualization \\
		  \hline
		  04-05 & Linear Algebra \\
		  \hline
...
% we proposed the Midterm Presentation.
% Now,
% let me summarize the differences between Midterm Presentation and outlying aspects mining.

% Midterm Presentation mainly focuses on the differences between groups.
% But outlying aspects mining mainly concentrates on the differences between objects.
% The target of Midterm Presentation can be seen as many points.
% While the target of outlying aspects mining can be regarded as one point.

% In the NBA example,
% Midterm Presentation focuses on the advantages
...
\begin{slide}{Next-Week Plan}
  \begin{table}[h]
    \begin{tabular}{|l||r|}
      \hline
      Date & Arrangment \\
      \hline \hline 
      4.13 & DV1-5,one page of notebook  \\
      \hline
      4.14 & DV6-10,one page of notebook \\
      \hline
      4.15 & DV11-15,one page of notebook \\
      \hline
      4.16 & DV16-DV20,one page of notebook \\
      \hline
      4.17 & DV20-DV25,one page of notebook \\
      \hline
      4.18 & LA1 \\
      \hline
      4.19 & LA2\\
...
% \begin{itemize}
% \item
% Identify Midterm Presentation based on the value
% of outlying degree.
...
% % Therefore,
% % it is not suitable for Midterm Presentation.
% % \end{note}
% %%==========================================================================================
